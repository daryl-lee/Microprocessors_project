...
global	collision_t1, collision_t2
...
collision_t1:
    ...
    bra	    collision_neg_t1   	;find d_x1-t1_x1
...
collision_t2:
    movlw   0x2a
    movwf   d_x1, A
    cpfsgt  t2_x1, A ;skip if t1_x1>d_x1
    bra	    collision_neg_t2   	;find d_x1-t1_x1
    subwf   t2_x1, W, A	;t1_x1-d_x1
    movwf   delta_x, A
    movlw   0x07
    cpfsgt  delta_x, A ;skip if delta_x>7 (>=8)
    bra	    collision_y_t2
